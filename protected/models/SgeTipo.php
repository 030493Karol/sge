...
/**
 * This is the model class for table "sge_tipo".
 *
 ...
 */
class SgeTipo extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'sgeEventos' => array(self::HAS_MANY, 'SgeEvento', 'Tipo_idTipo'),
			'sgeItemProgramacaos' => array(self::HAS_MANY, 'SgeItemProgramacao', 'Tipo_idTipo'),
		);
	}
	 ...
	 * @return SgeTipo the static model class
	 */
